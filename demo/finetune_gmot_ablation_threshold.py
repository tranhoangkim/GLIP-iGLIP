...
version = 8
SAVE_DIR = f'./ablation/ablation_{version}/vis_before'
DROP_SAVE_DIR = f'./ablation/ablation_{version}/vis_after'
BOX_SAVE_DIR = f'./ablation/ablation_{version}/GMOT_40_boxes'
FINAL_VIS_DIR = f'./ablation/ablation_{version}/vis_final'
