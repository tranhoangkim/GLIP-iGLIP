...
SAVE_DIR = f'./car_1/high_threshold_{high_threshold}/vis_before'
DROP_SAVE_DIR = f'./car_1/high_threshold_{high_threshold}/vis_after'
BOX_SAVE_DIR = f'./car_1/high_threshold_{high_threshold}/GMOT_40_boxes'
FINAL_VIS_DIR = f'./car_1/high_threshold_{high_threshold}/vis_final'
