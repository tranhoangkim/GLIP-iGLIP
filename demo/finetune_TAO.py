...
split = 'test'
DATA_DIR = f'/cm/shared/kimth1/Tracking/TAO_data/frames/{split}/YFCC100M'
SAVE_DIR = f'./TAO/{split}/vis_before'
DROP_SAVE_DIR = f'./TAO/{split}/vis_after'
BOX_SAVE_DIR = f'./TAO/{split}/boxes'
