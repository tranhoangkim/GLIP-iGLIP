...
SAVE_DIR = '/home/kimth1/GLIP/results_GMOT40_swinT/vis_before'
DROP_SAVE_DIR = '/home/kimth1/GLIP/results_GMOT40_swinT/vis_after'
BOX_SAVE_DIR = '/home/kimth1/GLIP/results_GMOT40_swinT/boxes'
FINAL_VIS_DIR = '/home/kimth1/GLIP/results_GMOT40_swinT/vis_final'
...
except_videos = os.listdir("/home/kimth1/GLIP/results_swinT_GMOT40/boxes")
...
# running_videos = ['person-2', 'person-3', 'person-1', 'person-0', 
# 'insect-0', 'insect-1', 'insect-2',
# 'car-0', 'car-1', 'bird-1', 'airplane-1']
# running_videos = ['ball-0', 'airplane-0', 'person-2']
running_videos = ['insect-0', 'insect-1', 'bird-0', 'bird-1']
CAPTION_MAP = {
    'ball-0': 'red object . red billiard . red ball',
    'car-1': 'white car',
    'ball-3': 'tennis ball',
    ...
    'car-0': 'car',
    'car-2': 'car',
    'balloon-2': 'yellow lanterns . orange lanterns',

    'insect-0': 'one flies . one yellow ant . one bee . one insect . one hornet . one wasp',
...
CAPTION_MAP2 = {
    'ball-0': 'ball . Colorful ball . billiard',
    'car-1': 'car'
}
THRES_MAP2 = {
    'ball-0': 0.2,
...
def main():
    assert len(CAPTION_MAP) == len(THRES_MAP) == len(COND_MAP)
    cfg.local_rank = 0
    cfg.num_gpus = 1
    ...
    for category in tqdm(os.listdir(DATA_DIR)):
        ...
        for frame_id, frame_name in enumerate(choice_fanmes):
            ...
            if caption != caption2:
                low_visual_bboxes, low_visual_features, low_scores = get_object_in_image(glip_demo, caption2, threshold2, condtition2, frame_name, img_folder, save_vis_before2, save_vis_after2)  
            else:
